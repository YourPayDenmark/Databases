...
INSERT INTO `user_login_psp` (`password`, `name`, `phone`, `email`, `user_id`, `session_id`, `access_rights`, `language`, `pspid`, `reset_token`, `reset_token_expiry`, `secret`) VALUES
('', NULL, NULL, '', 1000000,  NULL,  NULL, NULL, NULL, NULL, NULL, '');
